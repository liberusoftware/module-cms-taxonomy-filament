# CMS: Taxonomy Filament

> This optional Filament 5 presentation package presents exactly one independent domain module. It contributes reusable resources, pages, widgets, schemas, tables, infolists, and actions to application-owned panels while delegating authorization, validation, tenancy, persistence, and business rules to the cms-taxonomy public boundary. It must not c
...
[![Latest release](https://img.shields.io/github/v/release/liberusoftware/module-cms-taxonomy-filament?sort=semver)](https://github.com/liberusoftware/module-cms-taxonomy-filament/releases/latest) [![Tests](https://github.com/liberusoftware/module-cms-taxonomy-filament/actions/workflows/tests.yml/badge.svg?branch=main)](https://github.com/liberusoftware/module-cms-taxonomy-filament/actions/workflows/tests.yml)
...
```bash
composer require liberusoftware/module-cms-taxonomy-filament
```
...
<a href="https://github.com/liberusoftware/module-cms-taxonomy-filament/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=liberusoftware/module-cms-taxonomy-filament" alt="Contributors to liberusoftware/module-cms-taxonomy-filament">
</a>

[View the full contributors graph](https://github.com/liberusoftware/module-cms-taxonomy-filament/graphs/contributors).
